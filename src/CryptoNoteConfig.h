...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x55; // addresses start with "z"
...
const char     CRYPTONOTE_NAME[]                             = "daocoin";
...
const int      P2P_DEFAULT_PORT                              = 16888;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 18957;
